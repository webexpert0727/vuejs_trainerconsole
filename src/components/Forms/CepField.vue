<template>
  <div class="form__group" :class="{ 'has-danger' : hasError }">
    ...
    <input type="text" v-model="input" :id="name" :name="name" @keyup="keyUpHandle" :required="required" class="form-control" :class="{'is-danger': hasError }" autocomplete="off" maxlength="9">
